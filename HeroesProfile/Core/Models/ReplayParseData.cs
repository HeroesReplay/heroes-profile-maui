...
public class ReplayParseData : IEquatable<ReplayParseData>
{
    ...
    public bool Equals(ReplayParseData? other)
    {
        if (other is null)
        {
            return false;
    ...
    public override bool Equals(object? obj) => Equals(obj as ReplayParseData);

    public override int GetHashCode() => File.FullName.GetHashCode();
}