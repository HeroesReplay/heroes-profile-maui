...
public class PredictionsClient
{
    ...
    public async Task<EndPredictionResponse> EndPrediction(Dictionary<string, string> identity, string predictionId, PredictionEndStatus status, string outcomeId, CancellationToken cancellationToken)
    {
        var values = new Dictionary<string, string>(identity)
        {
